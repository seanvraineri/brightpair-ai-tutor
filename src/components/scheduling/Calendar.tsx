...
import TutoringSessionModal, { SessionData } from "./TutoringSessionModal";
...
const Calendar = () => {
  ...
  const handleSessionSchedule = (sessionData: SessionData) => {
    setIsSessionModalOpen(false);
    toast({
      title: "Session Scheduled",
      description: `${sessionData.title} scheduled for ${
        format(date!, "PPP")
      } at ${selectedTimeSlot}`,
    });
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-1">
          <CardHeader>
            ...
            <CardDescription>
              Choose a date for your tutoring session
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              {date
                ? `Select a time on ${format(date, "PPPP")}`
                : "Choose a date first"}
            </CardDescription>
          </CardHeader>
          <CardContent>
