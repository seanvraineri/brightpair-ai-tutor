...
import { BookText, CheckCircle, Trophy } from "lucide-react";
  ...
  const generateQuizQuestions = (topic: string): QuizQuestion[] => {
    ...
    if (topicLower === "algebra") {
      return [
        {
          question:
            "What is the slope of the line passing through points (2, 5) and (4, 9)?",
          options: ["1", "2", "3", "4"],
          correctAnswer: 1,
        },
        {
      ...
      return [
        ...
        {
          question:
            "Which of these is NOT a part of the central dogma of molecular biology?",
          options: [
            "DNA replication",
      ...
      toast({
        ...
        description: `The correct answer is: ${
          questions[currentQuestionIndex]
            .options[questions[currentQuestionIndex].correctAnswer]
        }`,
        variant: "destructive",
      });
    }
          ...
          {isLoading
            ? (
              <div className="flex flex-col items-center justify-center p-6">
                <div className="w-10 h-10 border-4 border-t-brightpair border-brightpair-200 border-solid rounded-md animate-spin">
                </div>
            ...
            ? (
              <div className="p-4">
                <div className="text-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-brightpair-700">
                    Quiz Completed!
                  </h3>
                  ...
                  <div className="mt-3">
                    ...
                    <p className="text-sm text-gray-600">
                      You got {calculateScore().correct} of{" "}
                      {calculateScore().total} questions correct
                    </p>
                  </div>
                    ...
                    <Progress
                      ...
                      className={cn(
                        ...
                        calculateScore().percentage >= 70
                          ...
                          : "bg-secondary [&>div]:bg-brightpair",
                      )}
                    />
                  </div>
                  ...
                  <div className="mt-4 p-3 rounded-md bg-gray-50 text-sm">
                    {calculateScore().percentage >= 90
                      ...
                      ? (
                        <p>
                          Good job! You have a solid understanding of the
                          material.
                        </p>
                      )
                      ...
                      ? (
                        <p>
                          Keep practicing! You're making progress with this
                          topic.
                        </p>
                      )
                      : (
                        <p>
                          This topic needs more review. Let's keep studying!
                        </p>
                      )}
                  </div>
                </div>
