...
import { Loader2, Save, Download, BarChart, Mail } from 'lucide-react';
        ...
        {!generatedReport ? (
          <div className="space-y-6">
            <div className="bg-blue-50 p-4 rounded-md border border-blue-100">
              <h3 className="text-sm font-medium text-blue-800 mb-2">About AI-Generated Reports</h3>
              <p className="text-sm text-blue-700">
                The AI will analyze the student's recent sessions, notes, and progress to generate
                a comprehensive report. You'll be able to review and edit before finalizing.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="include-sessions">Recent tutoring sessions</Label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="include-homework">Homework completion patterns</Label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="include-style">Learning style preferences</Label>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2">
                  {generatedReport.areas_for_improvement.map((area, index) => (
                    <li key={index} className="flex gap-2 items-start">
            ...
            <div className="space-y-3">
              <Label htmlFor="tutor-comments">Additional Comments (Optional)</Label>
              <Textarea
                id="tutor-comments"
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={(checked) => setEmailToParent(checked === true)}
              />
              <Label htmlFor="email-parent">Send report to parent by email</Label>
            </div>
          </div>
        )}
      </CardContent>
