    ...
    return (
      <Card className="shadow-card">
        <CardHeader>
          ...
          <CardDescription>
            Loading your customized study plan...
          </CardDescription>
        </CardHeader>
    ...
    return (
      <Card className="shadow-card">
        <CardHeader>
          ...
          <CardDescription>
            Get personalized recommendations based on your learning style
          </CardDescription>
        </CardHeader>
        <CardContent className="py-8 text-center">
          <p className="mb-4">
            No learning data available yet. Complete your learning profile to
            get started.
          </p>
              ...
              <div className="flex items-center justify-between bg-indigo-50 p-3 rounded-md">
                <div>
                  <p className="text-sm font-medium">
                    Course: {selectedStudyPlan.subject}
                  </p>
                ...
                <div className="text-right">
                  <p className="text-sm font-medium">
                    Due: {formatDate(selectedStudyPlan.dueDate)}
                  </p>
                  <p className="text-xs text-gray-500">
                    {calculateDaysUntil(selectedStudyPlan.dueDate)}{" "}
                    days remaining
                  </p>
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm">
                    Estimated time: {selectedStudyPlan.estimatedTimeMinutes}
                    {" "}
                    minutes
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  {selectedStudyPlan.suggestedActivities.map((
                    activity,
                    index,
                  ) => (
              ...
              <TabsContent value="upcoming" className="py-4">
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-3">
                      {learningPlan.upcomingDeadlines.slice(0, 3).map((
                        assignment,
                      ) => (
                        <div
                          key={assignment.id}
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right">
                              <span className="text-xs font-medium px-2 py-1 rounded-md bg-blue-100 text-blue-800">
                                {calculateDaysUntil(assignment.dueDate)}{" "}
                                days left
                              </span>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {learningPlan.topicsBySubject[subject]?.map((
                              topic,
                              i,
                            ) => (
                              <span
              ...
              <TabsContent value="review" className="py-4">
                <div className="space-y-6">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Based on your upcoming assignments and past performance, we
                    recommend reviewing these topics:
                  </p>
                  ...
                  <div className="space-y-3">
                    {learningPlan.recommendedReviewAreas.map((area, index) => (
                      <div
                        key={index}
                        className="border rounded-md p-4 bg-white flex justify-between items-center"
                      >
                  ...
                  <div className="bg-blue-50 p-4 rounded-md mt-6">
                    <h4 className="font-medium text-blue-800 mb-2 flex items-center gap-2">
                      ...
                      Learning Style:{" "}
                      {learningPlan.learningStyle.charAt(0).toUpperCase() +
                        learningPlan.learningStyle.slice(1)}
                    </h4>
