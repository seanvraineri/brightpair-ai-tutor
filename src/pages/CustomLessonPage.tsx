...
import { Book, FileText, Clock, Calendar, ExternalLink, Upload, Lightbulb } from 'lucide-react';
      ...
      <div className="bg-brightpair-50 p-4 rounded-lg mb-6">
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm">
              <span className="font-medium">Custom Lessons</span> are created from <span className="italic">your own materials</span>, like notes or uploaded PDFs.
              <span className="inline-block mt-1">
                <span className="font-medium">Standard Lessons</span> (available in the <a href="/lessons" className="text-brightpair underline">Lessons tab</a>) are system-generated from our curriculum.
              </span>
            </p>
          </div>
        </div>
            ...
            {isLoadingDocuments ? (
              ...
              userDocuments.map((doc: UserDocument) => (
                <Card key={doc.id} className="overflow-hidden">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription className="truncate">{doc.topic}</CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <div className="col-span-full flex flex-col items-center justify-center p-12 text-center">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Upload your first document or type your notes to create a custom lesson
                </p>
                <Button 
                  variant="outline" 
                  className="mt-4"
