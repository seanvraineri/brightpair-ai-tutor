...
import { ArrowLeft, FilterX, Search, SlidersHorizontal } from "lucide-react";
  ...
  const fetchHomeworkList = async () => {
    ...
    try {
      const status:
        ...
        | "graded"
        | "pending"
        | undefined = statusFilter === "all" ? undefined : statusFilter as any;
      const filters = {
        status,
            ...
            {loading
              ...
              ? (
                <div className="text-center py-8 text-gray-500">
                  No homework found. Create a new assignment using the
                  generator.
                </div>
              )
              : (
