...
const HomeworkCreator: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (template) {
      ...
      if (template === "math") {
        templatePrompt =
          "Create a mathematics homework assignment with algebraic equations and word problems";
        form.setValue("subject", "Mathematics");
      } else if (template === "reading") {
        templatePrompt =
          "Create a reading comprehension assignment with questions about the text";
        form.setValue("subject", "English");
      } else if (template === "vocabulary") {
        templatePrompt =
          "Create a vocabulary practice assignment with definitions and usage examples";
        form.setValue("subject", "English");
      }
  ...
  const generateHomework = async () => {
    try {
      ...
      const promptText = aiPrompt ||
        `Create a ${difficultyValue} level ${subjectValue} homework assignment`;
      ...
      if (subjectValue === "Mathematics") {
        ...
        sampleContent +=
          "5. Calculate the circumference of a circle with radius 5 units (use π ≈ 3.14)\n\n";
        sampleContent += "## Word Problems\n\n";
        sampleContent +=
          "6. A train travels at 60 mph. How long will it take to travel 240 miles?\n";
        sampleContent +=
          "7. If a shirt costs $25 and is on sale for 20% off, what is the final price?\n";
        ...
        sampleContent +=
          "2. Name three organelles found in an animal cell and describe their functions\n";
        ...
        sampleContent +=
          "5. Define the difference between an acid and a base\n\n";
        sampleContent += "## Experiment\n\n";
        sampleContent +=
          "6. Design a simple experiment to test the effect of light on plant growth. Include:\n";
        ...
        sampleContent +=
          "6. Create a project that demonstrates your understanding of " +
          subjectValue + "\n";
      }
      ...
      form.setValue(
        "title",
        `${subjectValue} Homework - ${new Date().toLocaleDateString()}`,
      );
      form.setValue(
        "description",
        `${
          difficultyValue.charAt(0).toUpperCase() + difficultyValue.slice(1)
        } level homework for ${subjectValue}`,
      );
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <FormDescription>
                          Use AI to adapt content difficulty and examples to
                ...
                <div className="border rounded-md p-4">
                  ...
                  >
                      ...
                      >
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <p className="text-xs text-gray-500">
                            PDFs, Word documents, images (Max 10MB each)
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="pt-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>
                                Instructions for uploaded content
                              </FormLabel>
                              <FormControl>
                                <Textarea
                    ...
                    <TabsContent value="create" className="space-y-4">
                      <Label htmlFor="homework-content">
                      ...
                      />
                      <p className="text-xs text-gray-500">
                        Tip: You can use markdown formatting for better
                        structure (e.g., # for headings, * for lists)
                      </p>
                    </TabsContent>
                    ...
                    <TabsContent value="ai" className="space-y-4">
                      <div className="mb-4">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Example: "Create a practice worksheet on linear
                          equations" or "Generate 5 reading comprehension
